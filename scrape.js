...
const fishList = [
  ...
  // "Queen conch",
  // // "Bearded fireworm",
  // "Hermodice carunculata", // bearded fireworm with class data
  // // "Christmas tree worm",
  // "Spirobranchus giganteus", // christmas tree worm
  // "Magnificent feather duster",
  // "Brown fanworm",
  // "Moon jelly",
  // "Lampocteis", // blood belly comb jelly
  // // "Comb jelly",
  // "Thimble jelly",
...
const run = async () => {
  ...
  const itv = setInterval(async () => {
    ...
    if (fishName in result) {
      total++;
      idx++;
      console.log("we have already SEEN", fishName);
      return;
    }
...
function test() {
  pbcopy(JSON.stringify({ testing: "what up" }));
}
...
/**
 * Omg, some don't have "class" but instead "clade" or "subclass".... I'm just manually amending the worms
 */
